# Generated by Django 2.2.5 on 2019-09-04 07:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.PositiveSmallIntegerField(choices=[(1, 'Positive'), (2, 'Negative')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=14)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('media', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Video')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('purpose', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.Dream')),
            ],
            options={
                'abstract': False,
            },
